-- N1 ANOMALIE CON LIVELLO = 'CRITICA' 
SELECT 
    A.ID AS ID_SENSORE, 
...
-- N2 NUMERO DI ROBOT UTILIZZATI DA OGNI MISSIONE
SELECT 
    M.ID AS ID_MISSIONE,
...
-- N3 SELEZIONARE LA CAUSA PRINCIPALE DI ANOMALIE
SELECT 
    A.CAUSA, 
    COUNT(*) AS NUM_VOLTE
FROM 
...
-- N4 IL NUMERO DI MEMBRI COINVOLTI IN CIASCUNA OPERAZIONE, PER OGNI SENSORE
SELECT 
    S.ID AS ID_SENSORE, 
...
-- N5 IL NUMERO DI INTERVENTI EFFETTUATI DA OGNI MEMBRO DELL'EQUIPAGGIO
SELECT 
...
-- N6 CERCARE IL SENSORE CHE NON HA MAI AVUTO UNA ANOMALIA
SELECT 
    ID
FROM 
    SENSORI
